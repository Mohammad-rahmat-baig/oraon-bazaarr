...
import { Package, ShoppingCart, BarChart3, Settings, LogOut, Menu, X } from "lucide-react"
...
export default function SellerSidebar({ activeTab, setActiveTab }: SellerSidebarProps) {
